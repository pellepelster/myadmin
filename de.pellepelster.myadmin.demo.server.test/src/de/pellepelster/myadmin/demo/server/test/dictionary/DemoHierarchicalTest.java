...
public final class DemoHierarchicalTest extends BaseDemoDictionaryTest
{
	...
	public void testGetChildren()
	{
		...
		Assert.assertEquals(DemoDictionaryModel.MANAGER.getName(), childNodes.get(0).getDictionaryName());
	}
	...
	public void testGetRootNodes()
	{
		...
		Assert.assertEquals(DemoDictionaryModel.COMPANY.getName(), rootNodes.get(0).getDictionaryName());
	}
