...
public class Test1VO extends BaseVO implements IBaseVO
{
	...
	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Integer> FIELD_INTEGER1 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Integer>(
			"integer1", Integer.class, Integer.class);

	private Integer integer1;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<BigDecimal> FIELD_BIGDECIMAL1 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<BigDecimal>(
			"bigDecimal1", BigDecimal.class, BigDecimal.class);

	private BigDecimal bigDecimal1;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Boolean> FIELD_BOOLEAN1 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Boolean>(
			"boolean1", Boolean.class, Boolean.class);

	private Boolean boolean1;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Date> FIELD_DATE1 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Date>(
			"date1", Date.class, Date.class);

	private Date date1;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<ENUM1> FIELD_ENUMERATION1 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<ENUM1>(
			"enumeration1", ENUM1.class, ENUM1.class);
	...
	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<List<Test2VO>> FIELD_TEST2VOS = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<List<Test2VO>>(
			"test2VOs", List.class, Test2VO.class);
