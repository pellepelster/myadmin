...
public class Test2VO extends BaseVO implements IBaseVO {
	...
	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<String> FIELD_STRING2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<String>("string2", String.class, String.class);

	private String string2;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Integer> FIELD_INTEGER2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Integer>("integer2", Integer.class, Integer.class);

	private Integer integer2;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<BigDecimal> FIELD_BIGDECIMAL2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<BigDecimal>("bigDecimal2", BigDecimal.class,
			BigDecimal.class);

	private BigDecimal bigDecimal2;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Boolean> FIELD_BOOLEAN2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Boolean>("boolean2", Boolean.class, Boolean.class);

	private Boolean boolean2;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<Date> FIELD_DATE2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<Date>("date2", Date.class, Date.class);

	private Date date2;

	public static final de.pellepelster.myadmin.client.base.db.vos.IAttributeDescriptor<ENUM2> FIELD_ENUMERATION2 = new de.pellepelster.myadmin.client.base.db.vos.AttributeDescriptor<ENUM2>("enumeration2", ENUM2.class, ENUM2.class);
