 ...
 * 
 */
public class EditableTableModel extends BaseModel implements IEditableTableModel
{

	private static final long serialVersionUID = 3081898707258005525L;
	...
	public EditableTableModel(IBaseModel parent, DictionaryContainerVO containerVO)
	{
		super(parent);
	...
	{
		return containerVO.getEntityName();
	}
