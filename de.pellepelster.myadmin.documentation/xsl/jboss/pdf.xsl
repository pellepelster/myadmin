...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://docbook.org/ns/docbook"
  ...
  <xsl:import href="http://docbook.sourceforge.net/release/xsl/1.78.0/fo/docbook.xsl"/>
 ...
 <xsl:template name="verso.authorgroup">
   <fo:table table-layout="fixed" width="100%">
     ...
     <fo:table-body>
       <xsl:apply-templates select="d:author" mode="tablerow.titlepage.mode"/>
       <xsl:apply-templates select="d:editor" mode="tablerow.titlepage.mode"/>
       <xsl:apply-templates select="d:othercredit" mode="tablerow.titlepage.mode"/>
     </fo:table-body>
   </fo:table>
 </xsl:template> -->
  ...
  <!-- <xsl:template name="book.titlepage.recto">
   ...
   <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:bookinfo/d:issuenum"/>
   <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:info/d:issuenum"/>
   <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:issuenum"/>
   ...
   <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:bookinfo/d:authorgroup/d:author"/>
   ...
   <fo:block xsl:use-attribute-sets="book.titlepage.recto.style" color="black">
     <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:bookinfo/d:invpartnumber"/>
     <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="d:info/d:invpartnumber"/>
   </fo:block>
   <fo:block xsl:use-attribute-sets="book.titlepage.recto.style" color="black">
     <xsl:call-template name="gentext">
  ...
  <!-- <xsl:template name="book.titlepage.verso">
   <xsl:choose>
     <xsl:when test="d:bookinfo/d:abstract">
  ...
  <!-- <xsl:template name="book.titlepage3.recto">
   ...
   <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:bookinfo/d:publisher"/>
   <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:info/d:publisher"/>
 </xsl:template> -->
