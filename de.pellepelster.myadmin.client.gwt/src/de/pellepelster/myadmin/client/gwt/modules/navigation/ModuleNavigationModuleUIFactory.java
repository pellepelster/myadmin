...
public class ModuleNavigationModuleUIFactory implements IModuleUIFactory<Panel, ModuleNavigationModule>
{
	...
	{
		return new ModuleNavigationModuleUI((ModuleNavigationModule) module);
	}
