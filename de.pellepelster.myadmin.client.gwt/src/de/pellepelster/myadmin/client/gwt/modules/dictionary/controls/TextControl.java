...
public class TextControl extends TextBox implements IUIControl<Widget>
{

	private final ITextControlModel textControlModel;
	private final ControlHelper gwtControlHelper;

	public TextControl(ITextControlModel textControlModel)
	{
		super();
	...
	{
		gwtControlHelper.setValidationMessages(validationMessages, textControlModel);
	}
